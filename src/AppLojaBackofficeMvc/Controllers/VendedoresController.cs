...
namespace AppLojaBackofficeMvc.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendedorId,VendedorNomeCompleto,VendedorEmail")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("VendedorId,VendedorNomeCompleto,VendedorEmail")] Vendedor vendedor)
        {
